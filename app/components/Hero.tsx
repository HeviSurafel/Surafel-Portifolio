        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-start">
          ...
          <div className="flex lg:flex-col gap-4 order-2 lg:order-1">
            <a
              ...
              className="text-gray-600 hover:text-blue-500 transition-colors duration-300 p-3 rounded-full hover:bg-gray-100"
            >
            ...
            <a
              ...
              className="text-gray-600 hover:text-pink-500 transition-colors duration-300 p-3 rounded-full hover:bg-gray-100"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="text-gray-600 hover:text-blue-600 transition-colors duration-300 p-3 rounded-full hover:bg-gray-100"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="text-gray-600 hover:text-gray-900 transition-colors duration-300 p-3 rounded-full hover:bg-gray-100"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Hero Text Content */}
          <div className="text-gray-800 space-y-6 order-1 lg:order-2 flex-1">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-lg">
            <div className="relative rounded-2xl overflow-hidden shadow-xl">
              <Image
                src="/images/surafel.jpg" // Replace with your image path
                alt="Hero Image"
                width={500}
                height={500}
            ...
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"></div>
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-purple-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse delay-1000"></div>
          </div>
        </div>
      </div>
    </div>
