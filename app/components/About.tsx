          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                I'm a passionate Frontend Developer and UI/UX Designer with over 2 years of experience 
                creating modern, responsive web applications. I love turning complex problems into 
                simple, beautiful designs.
              </p>
              <p className="text-gray-600 leading-relaxed">
                My journey in web development started with curiosity and has evolved into a career 
                focused on creating user-centered solutions that combine functionality with aesthetic appeal.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 hover:bg-orange-50 transition-colors duration-300">
                  ...
                  <span className="font-medium text-gray-700">Performance Optimization</span>
                </div>
              </div>
            </div>
